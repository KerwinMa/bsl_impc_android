...
public class TwoStateImageView extends ImageView {
    ...
    private static final String TAG = TwoStateImageView.class.getSimpleName();
    private static final int DISABLED_ALPHA = (int) (0.4 * 255);
    private static final int TRANSPARENT_ALPHA = 255;
