 ...
 * date: 2011-05-04
 */
public class JScrollLayout extends ViewGroup {
	...
	public JScrollLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		// TODO Auto-generated constructor stub
	}

	public JScrollLayout(Context context, AttributeSet attrs, int defStyle) {
