	...
	OnClickListener listener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.setting_btn_about:
				Intent i = new Intent();
				i.setClass(SettingsbakActivity.this, AboutActivity.class);
				startActivity(i);
				break;
			case R.id.setting_btn_update:
				if (application.getLoginType() == TmpConstants.LOGIN_OUTLINE) {
					...
					new CheckUpdateTask(
							...
							new ManualCheckUpdateListener(SettingsbakActivity.this))
							.execute();
				}
				break;
			case R.id.setting_btn_pushstting:
				if (application.getLoginType() == TmpConstants.LOGIN_OUTLINE) {
					...
					intent.setClass(SettingsbakActivity.this,
							PushSettingActivity.class);
					startActivity(intent);
				}
				break;
			case R.id.logoff:
				Dialog dialog = new AlertDialog.Builder(SettingsbakActivity.this)
						.setTitle("提示")
						.setMessage("确认要注销？")
