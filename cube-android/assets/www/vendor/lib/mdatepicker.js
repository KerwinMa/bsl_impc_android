...
/*!
 * jQuery mdatepicker v2.3
 * http://mdatepicker.com
 *
...
(function ($) {
    ...
    function Scroller(elem, settings) {
        ...
        */
        that.show = function (prevAnim) {
            ...
            var html = '<div class="' + s.theme + ' dw-' + s.display + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi"><div class="dwwr">' : persPS + '<div class="dwo"></div><div class="dw dwbg ' + mAnim + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' 
			+ (isDialog ? ('<div  style="text-align:left;" class="dwv">&nbsp;&nbsp;'+ s.title +'</div>') : ('<div class="dwv">'+ (s.headerText?s.headerText:'') +'</div>') )	
			);
			if(isDialog) {
				if( s.dialogHtml)
				html += "<div  class='dwc dwsc' style='text-align:left; padding-bottom: "+s.dbottom+"px; padding-top:"+s.dtop+"px; px; min-width:"+s.width+"px; '>" + s.dialogHtml + "</div>";
			}
			else {
            ...
            if (s.display != 'inline') {
                ...
                $('.dwb-c span', dw).click(function () {
                    if (that.hide() !== false) {						
						...
						/*if(isDialog && s.callback) {
							s.callback.call(that, "cancel");
						}*/
                    }
                    return false;
                });
    ...
    $.fn.mdatepicker = function (method) {
        extend(this, $.mdatepicker.shorts);
        return init(this, method, arguments);
    };
	$.fn.dialog = function (method) {
        extend(this, $.mdatepicker.shorts);
        init(this, 'destroy', arguments);
		return init(this, method, arguments);
    };
    ...
    $.scroller = $.scroller || $.mdatepicker;
    $.fn.scroller = $.fn.scroller || $.fn.mdatepicker;
	window.scrollers =  window.scrollers || scrollers;
                ...
                methods: {
                    ...
                    */
                    getDate: function (temp) {
                        var inst = $(this).mdatepicker('getInst');
                        if (inst) {
