 ...
 * 
 */
define(['jquery', 'jquery.tmpl','underscore','cube/cache','cube/cube-loader'], function($, na,_,Cache,Loader){
	...
	Form.prototype.loadPage = function(){
		...
		$.ajax({
			...
			success: function(data, textStatus, jqXHR){
				...
				$.tmpl(itemTemplateName, jsonRoot).appendTo(document.getElementById(me.config['id']));
